 ...
 */
public class TelaLoginVM extends javax.swing.JFrame {
...
//    }
    ...
    private void initComponents() {
        ...
        txtLogin.setVerticalAlignment(javax.swing.SwingConstants.TOP);
                    ...
                    .addGroup(painelGeralBackgroundLayout.createSequentialGroup()
                        ...
                        .addGroup(painelGeralBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(painelGeralBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(inputSenha, javax.swing.GroupLayout.DEFAULT_SIZE, 363, Short.MAX_VALUE)
...
//        String retorno = textfield.getText();
            ...
            if (inputEmail.equals(user.get(0).getEmail_usuario()) && inputSenha.equals(user.get(0).getSenha()) && permissao) {
                TelaTokenVm telaTokenVm = new TelaTokenVm(user.get(0));
                validacaoOpcao = true;
                telaTokenVm.setVisible(true);
                timer.scheduleAtFixedRate(new TimerTask(){
                @Override public void run(){
                if(telaTokenVm.getFecharLogin()){
                dispose();
